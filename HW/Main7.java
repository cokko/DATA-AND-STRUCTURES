public class Main7 {
    public static void main(String[] args) {
        ...
        System.out.print(dfs.getNumberOfVerticesFound() + " vertices were searched in this order: ");
        for (int i = 0; i < searchOrders.size(); i++) {
            System.out.print(graph.getVertex(searchOrders.get(i)) + (i < searchOrders.size() - 1 ? " -> " : ""));
        }
        System.out.println("\n");
        ...
        for (int i = 0; i < graph.getSize(); i++) {
            ...
            if (parentIndex != -1) { 
                System.out.println("Parent of " + graph.getVertex(i) + " is " + graph.getVertex(parentIndex));
            } else {
                System.out.println(graph.getVertex(i) + " is the root (no parent).");
            }
        }
        System.out.println();
